...
export function MediaFrame({
  ...
  return (
    ...
    >
      <div className={cx("absolute inset-0", toneStyle.glow)} />
      {videoSrc ? (
        <video
          autoPlay
      ...
      <div className="absolute inset-0 bg-[linear-gradient(125deg,rgba(255,255,255,0.12),transparent_30%,transparent_68%,rgba(255,255,255,0.08))] opacity-50 mix-blend-screen" />
      <div className="brandbuild-sheen absolute inset-y-0 left-[-28%] w-[42%] bg-white/10 blur-3xl" />
      <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(5,7,11,0.04),rgba(5,7,11,0.2)_42%,rgba(5,7,11,0.82)_92%)]" />
      ...
      <div className="absolute right-5 top-5 rounded-full border border-white/10 bg-black/35 px-3 py-1 text-[10px] font-medium tracking-[0.2em] text-white/60 uppercase">
        Slot {slotId}
      </div>
